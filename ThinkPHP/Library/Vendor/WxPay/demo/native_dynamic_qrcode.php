...
*/
	...
	$boolflag1=($unifiedOrderResult["code_url"] != NULL);
...
<body>
	...
	<div align="center">
		<form  action="./order_query.php" method="post">
			<input name="out_trade_no" type='hidden' value="$out_trade_no">
	...
	<script src="http://wxcms.zhijianun.com/shopnc/shop/api/payment/wxpay/demo/qrcode.js"></script>
	<script>
		if($boolflag1)
		{
			var url = "$code_url";
