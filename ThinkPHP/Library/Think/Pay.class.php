...
class Pay {
    ...
    public function __construct($driver, $config = array()) {
        ...
        $this->config['notify_url'] = U("Store/Alipayapi/notify", array('apitype' => $apitype, 'method' => 'notify'), false, true);
        $this->config['return_url'] = U("Store/Alipayapi/return", array('apitype' => $apitype, 'method' => 'return'), false, true);
