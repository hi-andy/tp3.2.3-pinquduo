...
class AutomationController extends BaseController
{
    ...
    public function auto_add_group_buy() {
        ...
        foreach ($goods as $k => $v){
            ...
            $group_buy_values .= "(".time().",{$end_time},{$v['goods_id']},{$v['prom']},1,1,{$v['prom_price']},'{$v['goods_name']}',{$v['market_price']},'{$v['goods_name']}','".CDN."/Public/upload/logo/logo.jpg',{$user['user_id']},{$v['store_id']},1),";
        }
