...
function get_province(){
    var url = '/Admin/Api/getRegion?level=1&parent_id=0';
    $.ajax({
        type : "GET",
        url  : url,
...
function get_category(id,next,select_id){
    var url = '/Home/api/get_category?parent_id='+ id;
    $.ajax({
        type : "GET",
        url  : url,
        error: function(request) {
 ...
 * 获取多级联动的商品分类
 */
function get_category_haitao(id,next,select_id){
	var url = '/Home/api/get_category_haitao?parent_id='+ id;
	$.ajax({
		type : "GET",
		url  : url,
		error: function(request) {
